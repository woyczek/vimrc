...
hi SpecialKey term=bold ctermfg=6 guifg=Cyan
hi NonText term=bold cterm=bold ctermfg=4 gui=bold guifg=Cyan
hi Directory term=bold ctermfg=4 guifg=Cyan
hi ErrorMsg term=standout cterm=bold ctermfg=7 ctermbg=1 gui=bold guifg=White guibg=#ff0000
...
hi WarningMsg term=standout ctermfg=1 gui=bold guifg=#ff0000
